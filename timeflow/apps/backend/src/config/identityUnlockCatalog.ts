...
export const UNLOCK_CATALOG: CatalogEntry[] = [
  ...
  {
    unlockKey: 'flow_accessory_kind_eyes',
    unlockType: 'flow_accessory',
    grantedByStage: null,
    grantedByLevel: 5,
    displayName: 'Kind eyes',
    description: 'A softer expression for patient, sustainable progress.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_star_visor',
    unlockType: 'flow_accessory',
    grantedByStage: null,
    grantedByLevel: 9,
    displayName: 'Star visor',
    description: 'A crisp visor for days when Flow is locked in.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_starry_eyes',
    unlockType: 'flow_accessory',
    grantedByStage: 'Builder',
    grantedByLevel: null,
    displayName: 'Starry eyes',
    description: 'A delighted look for the first identity breakthrough.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_tide_ring',
    unlockType: 'flow_accessory',
    grantedByStage: 'Builder',
    grantedByLevel: null,
    displayName: 'Tide ring',
    description: 'A calm ring of motion for routines that now have rhythm.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_moon_hood',
    unlockType: 'flow_accessory',
    grantedByStage: 'Disciplined',
    grantedByLevel: null,
    displayName: 'Moon hood',
    description: 'A quiet hood for disciplined work done when no one is watching.',
  },
  {
    unlockKey: 'flow_accessory_ember_orbit',
    unlockType: 'flow_accessory',
    grantedByStage: 'Disciplined',
    grantedByLevel: null,
    displayName: 'Ember orbit',
    description: 'A warm orbit for streaks that keep their heat.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_trophy_circlet',
    unlockType: 'flow_accessory',
    grantedByStage: 'Embodied',
    grantedByLevel: null,
    displayName: 'Trophy circlet',
    description: 'A polished circlet for habits that have become second nature.',
  },
  {
    unlockKey: 'flow_accessory_night_garden',
    unlockType: 'flow_accessory',
    grantedByStage: 'Embodied',
    grantedByLevel: null,
    displayName: 'Night garden',
    description: 'A serene backdrop for mature routines with deep roots.',
  },
  {
  ...
  {
    unlockKey: 'flow_accessory_laser_focus',
    unlockType: 'flow_accessory',
    grantedByStage: 'FutureSelf',
    grantedByLevel: null,
    displayName: 'Laser focus',
    description: 'A sharp-eyed look for the version of you that knows the path.',
  },
  {
    unlockKey: 'flow_accessory_constellation',
    unlockType: 'flow_accessory',
    grantedByStage: 'FutureSelf',
    grantedByLevel: null,
    displayName: 'Constellation aura',
    description: 'A stellar aura for connecting many small wins into one identity.',
  },
  {
    unlockKey: 'flow_accessory_aurora_sky',
    unlockType: 'flow_accessory',
    grantedByStage: 'FutureSelf',
    grantedByLevel: null,
    displayName: 'Aurora sky',
    description: 'A luminous backdrop for Flow at the edge of your next chapter.',
  },
  {
