-- Repair migration: identity evolution DDL may be missing while 20260427120000 is
-- recorded in _prisma_migrations (e.g. pooler/baseline drift). All statements are idempotent.
