      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <a
            ...
            className="group relative px-8 py-4 bg-white text-teal-600 rounded-lg font-semibold text-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
          >
          ...
          <a
            href="/contact"
            className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white/30 rounded-lg font-semibold text-lg hover:bg-white/20 transition-all duration-300 hover:-translate-y-1"
          >
            Book a Demo
          </a>
        </motion.div>
