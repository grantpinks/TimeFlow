...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseStyles =
      'w-full px-4 py-3 text-base md:text-sm min-h-[48px] md:min-h-[44px] border rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed';
